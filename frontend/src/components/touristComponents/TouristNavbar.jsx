...
function AdminNavbar(){
    ...
    return(
        ...
        <ul className="hidden sm:flex gap-3 text-lg font-medium p-2">
            <NavLink to="/tourist/itineraries" className="flex flex-col items-center gap-1">
                <p>Itineraries</p>
            ...
            <NavLink to="/tourist/products" className="flex flex-col items-center gap-1">
                <p>Products</p>
                <hr className="w-2/4 border-none h-[1.5px] bg-gray-700 hidden"/>
            </NavLink>
            ...
            <NavLink to="/tourist/activities" className="flex flex-col items-center gap-1">
                <p>Activities</p>
                <hr className="w-2/4 border-none h-[1.5px] bg-gray-700 hidden"/>
            </NavLink>
            ...
            <NavLink to="/tourist/museums" className="flex flex-col items-center gap-1">
                <p>Musuems and Historical Places</p>
                <hr className="w-2/4 border-none h-[1.5px] bg-gray-700 hidden"/>
            </NavLink>

            <div className="w-0  border-r border-[#f5e1b4]"/>

            <NavLink to="/tourist/profile" className="flex flex-col items-center gap-1">
