...
<div className="relative z-0 w-full mb-5 group">
  <div className="flex justify-between items-center">
    <label
      htmlFor="lat"
      className="peer-focus:font-medium text-2xl text-gray-500 duration-300 transform -translate-y-6 scale-75 origin-[0] peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
    >
      Latitude
    </label>
